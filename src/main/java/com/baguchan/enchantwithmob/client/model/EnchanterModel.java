...
public class EnchanterModel<T extends EnchanterEntity> extends SegmentedModel<T> implements IHasArm, IHasHead {
    ...
    public EnchanterModel() {
		...
		this.body.setTexSize(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		this.body.setTexSize(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 18.0F, 6.0F, 0.5F, 0.5F, 0.5F);
		...
		this.arms.setTexSize(40, 38).addBox(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.0F);
